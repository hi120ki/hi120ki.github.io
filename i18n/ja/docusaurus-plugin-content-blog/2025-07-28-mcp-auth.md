...
description: "MCPが推奨するDynamic Client Registrationは既存の認可サーバーで使えず、Backend Servicesへの認可のベストプラクティスも未確立です。Enterprise-Managed Authorization ProfileはID-JAGを用いてIdPをアクセストークン発行のハブに据えます。"
authors: [hi120ki]
...
**[→ English version](https://hi120ki.github.io/blog/posts/20250728/)**
