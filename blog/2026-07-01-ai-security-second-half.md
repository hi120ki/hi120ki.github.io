...
The technical documentation requirements in Article 11 and Annex IV of the EU AI Act take effect for high-risk AI systems on August 2, 2026, making AIBOM unavoidable ([What Is an AI-BOM (AI Bill of Materials)?](https://www.paloaltonetworks.com/cyberpedia/what-is-an-ai-bom)). CISA has published [Software Bill of Materials for AI - Minimum Elements](https://www.cisa.gov/resources-tools/resources/software-bill-materials-ai-minimum-elements), and OWASP has published [the OWASP AIBOM schema](https://owaspaibom.org/), and standardization is progressing.
