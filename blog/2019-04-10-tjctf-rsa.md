...
description: "A crypto challenge where Msieve factors the modulus into two 30 digit primes, then the extended Euclidean algorithm recovers d and decrypting the ciphertext prints the flag."
authors: [hi120ki]
