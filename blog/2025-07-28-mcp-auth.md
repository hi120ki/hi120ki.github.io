...
description: "Dynamic Client Registration blocks enterprise MCP adoption because Okta and Google can't act as authorization servers without pre-registration. Also covers the confused deputy problem, the Enterprise-Managed Authorization Profile proposal, ID-JAG, and Okta Cross App Access."
authors: [hi120ki]
...
**[→ 日本語版 / Japanese version](https://hi120ki.github.io/ja/blog/posts/20250728/)**
